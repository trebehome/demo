...
// Control buttons
const recordStart = document.querySelector("#recordStartButton1");
const recordStop = document.querySelector("#recordEndButton1");
...
recordStart.onclick = () => {
    ...
    navigator.mediaDevices.getUserMedia({ audio: true })
        .then((stream) => {
            ...
            $("#recordStartButton1").prop("disabled", true);
            $("#recordEndButton1").prop("disabled", false);
...
recordStop.onclick = () => {
    ...
    // Enable/disable control buttons
    $("#recordStartButton1").prop("disabled", false);
    $("#recordEndButton1").prop("disabled", true);
}
